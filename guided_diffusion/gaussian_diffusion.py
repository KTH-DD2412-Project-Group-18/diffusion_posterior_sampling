...
class GaussianDiffusion:
    """
    Utilities sampling diffusion models.
    ...
    def __init__(
        ...
        *,
        ...
        # This should be beta * sqrt(\bar\alpha_{t-1})/(1-\bar\alpha_t)
    ...
    def forward_diffusion(self, x_start, t, noise=None):
            """
            Compute forward diffusion as in DDPM/DDIM (previously named q_sample)
    ...
    def ddim_sample_loop_progressive(
        ...
        for i in indices:
            ...
            with th.no_grad():
                ...
                # TODO: Apply the DPS sampling instead

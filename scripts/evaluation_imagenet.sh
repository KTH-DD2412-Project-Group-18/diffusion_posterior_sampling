...
# List of measurement folders
REFERENCE_DATASET_PATH="datasets/eval_imagenet_sorted"
LOG_FILE="output/imagenet_metrics_log.txt"
MEASUREMENT_FOLDERS=('RandomInpainting_imagenet_sorted' 'BoxInpainting_imagenet_sorted' \
                     'SuperRes_imagenet_sorted' 'MotionBlur_imagenet_sorted' \
                     'GaussianBlur_imagenet_sorted')
